...
class BaseForm(models.Model):
    ...
    # Related
    departament_id          = fields.Many2one(related="employee_id.department_id", string="Departamento", store=True, readonly=False, required=True,tracking=True)
    # este campo categoria_ids, lo usaron para cargar categorias, pero me praece q en algun momento se tiene que crear otro,
    categoria_ids           = fields.Many2many(related="employee_id.category_ids", string='Categoria', readonly=False, required=True, tracking=True)
